...
def add_dish():
    ...
    menu[dish_id] = {"id": dish_id, "name": dish_name, "price": dish_price, "stock": dish_stock, "availability": dish_availability}
...
def take_order():
    ...
    if dish['availability'] == "Yes" and dish['stock'] > 0:
        ...
        orders[order_id] = {"Customer Name": customer_name, "Dish ID": dish_id, "Status": "Ready"}
...
def update_order_status():
    ...
    new_status = input("Enter new status (Received, Pending, Ready, Delivered): ")
...
def review_orders():
    print("All Orders:")
    print("{:<10} {:<20} {:<10} {:<10}".format("Order ID", "Customer Name", "Dish ID", "Status"))
    for order_id, order_details in orders.items():
        print("{:<10} {:<20} {:<10} {:<10}".format(order_id, order_details['Customer Name'], order_details['Dish ID'], order_details['Status']))
    print()

def view_menu():
    print("Menu:")
    print("{:<10} {:<20} {:<10} {:<10}".format("Dish ID", "Dish Name", "Dish Price", "Availabilty"))
    for dish_id, dish in menu.items():
        print("{:<10} {:<20} {:<10} {:<10}".format(dish['id'], dish['name'], dish['price'], dish['availability']))
    print()
